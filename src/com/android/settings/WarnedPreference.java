...
public class WarnedPreference extends Preference implements RadioGroup.OnCheckedChangeListener,
    ...
    private String TAG = "WarnedPreference";
    ...
    public WarnedPreference(Context context, AttributeSet attrs) {
        ...
        setSummary(getWarnedPreferenceSummary());
    }
    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
        ...
        boolean isChecked = mContext.getSharedPreferences(FontSizePreferenceController.FILE_FONT_WARING,
                Activity.MODE_PRIVATE).getBoolean(FontSizePreferenceController.KEY_IS_CHECKED, false);
